...
from auth import login, is_authanticated, create_user
                ...
                while flag != "y" and flag != "n":
                    ...
                    if flag == "y":
                        if "flags" in data.keys():
                            ...
                            bandera(country, flag_im, img_format, user_name)  
...
while user != "q":
    ...
    if user == "1":
        ...
        if is_authanticated(name, pwd):
            ...
            print("Wrong user or pwd")
            input()
            system("clear")
    elif user == "2":
        name = input("Name: ")
        pwd = input("Pwd: ")
        new_user = create_user(name, pwd)
        if new_user:
            print("User created")
            input()
            system("clear")
