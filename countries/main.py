...
from utils import menu, exist_country, info, bandera, continent_choises, count_in_continent, numerical, questions, capital, clear, result, get_all, language
    ...
    if user == "1":
        ...
        if printing == False:
            ...
            while flag != "y" and flag != "n":
                ...
                if flag == "y":
                    if req.get(list(data["flags"].values())[0]):
        ...
        if user_1.isnumeric() == False:
            print("Option not valid")
            clear()
            pass
        elif int(user_1) not in range(1,6):
            print("Option not valid")
            clear()
            pass
        ...
        quest_list=[numerical(list_countries, "area"), numerical(list_countries, "population"), capital(list_countries), language(list_countries)]
        shuffle(quest_list)
        points = 0
        for i in quest_list:
            quest, answer = i
